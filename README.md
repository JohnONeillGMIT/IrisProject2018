...
##### Table 1:Measures of Variables![Image of Print Output from python code](SimpleMeasuresr4_Output.PNG)

 
After discovering the Numpy & Panda modules, I was able to pull the required data in a much cleaner manner. A ![Summary Output file](Summary.txt)  of the ![Python script](Applying_pandas_on_Iris_Table.py)
...
x.The oppisite applies o the Sepal Widths. In this case the data shows setosa to be signigicantly wider that both alternatives
