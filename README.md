...
Through further research I have since discovered [Pandas](https://pandas.pydata.org/), NumPy, [Mathplotlib](https://matplotlib.org/) and [seaborn](https://seaborn.pydata.org) as useful and more effective/efficient means of data mining as well as producing highly effective visualistion of the data.
